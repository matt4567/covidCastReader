...
def getDataForStates(state, type):
    res = Epidata.covidcast(type, signalsDict[type], 'day', 'state', Epidata.range(20200201, 20200526),
                            state)
...
def getDataForMetAreas(metCode, type):
    res = Epidata.covidcast(type, signalsDict[type], 'day', 'msa', Epidata.range(20200201, 20200526),
                            metCode)
